export const SKILLS = [
  ...
  {
    img_url: "./assets/images/sql_icon.png",
  },
  {
    img_url: "./assets/images/postgre_icon.png",
  },
  {
    img_url: "./assets/images/nextjs_icon.svg",
  },
  {
...
export const PROJECT_WORKS = [
  ...
  },
  {
    ...
    project_type: "FullStack Project",
    project_description: [
      "School login portal where both parents and students can login with their credentials. Students can access lectures and notes. Parents can see the childrens fee payment status and progress result.",
    ],
    languages_used:
  ...
  },
  {
    ...
    project_description: [
      "Beautiful frontend responsive coffee webpage which includes features like Home, About, Menu, Products, Review, Contact, Blogs section.",
    ],
  ...
  },
  {
    ...
    project_description: [
      "Checkbox detection using deep learning and OpenCV involves training a neural network, often a Convolutional Neural Network (CNN), to identify and classify checkboxes in scanned documents or images",
    ],
  ...
  },
  {
    ...
    project_description: [
      "Developed a content-based movie recommender system using Python and TF-IDF for accurate predictions.",
  ...
  },
  {
    ...
    project_description: [
      "Developed a sentiment analysis tool using SVM for accurate text classification.",
  ...
  },
  {
    ...
    project_type: "Deep Learning",
    project_description: [
      "Built a CNN model with Keras for accurate plant leaf disease classification.",
